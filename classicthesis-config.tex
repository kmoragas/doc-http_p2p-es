...
\newcommand{\myDegree}{Maestr\'{i}a Cient\'{i}fica en Telem\'{a}tica\xspace}
...
\newcommand{\myDepartment}{Programa de Maestr\'{i}a\xspace}
\newcommand{\myUni}{Instituto Tecnol\'{o}gico de Costa Rica\xspace}
\newcommand{\myLocation}{San Jos\'{e}, Costa Rica\xspace}
\newcommand{\myTime}{Noviembre, 2014\xspace}
\newcommand{\myVersion}{Versi\'{o}n 1.0\xspace}
...
\usepackage{mparhack} % Used to align the margin the left or right depending on the page number
...
\definecolor{brown}{HTML}{8A4A0B}
\definecolor{tecblue}{HTML}{0D436F}
...
\lstdefinelanguage{XML}
{
  ...
  morekeywords={xmlns,version,clientid,requestid,responseid}% list your attributes here
}
...
%  identifierstyle=\color{darkblue},
%  keywordstyle=\color{cyan},
%  morekeywords={xmlns,version,type,clientid,requestid,responseid}% list your attributes here
%}
