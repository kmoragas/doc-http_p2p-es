...
\ctparttext{Como parte de una introducción, se describirán las razones que impulsaron el desarrollo de ésta investigación, mostrando el problema su justificación y además cuáles son los objetivos propuestos.} % Text on the Part 1 page describing  the content in Part 1

\part{Introducción} % First part of the thesis

\include{Chapters/Chapter01} % Chapter 1 - Introducción

\ctparttext{En los siguente capítulos se aclararán temas relacionados a los protocolos utilizados por CWC, como lo son HTTP y P2P. Además establecerán todas aquellas definiciones necesarias para el desarrollo de la presente investigación.} % Text on the Part 1 page describing  the content in Part 1

\part{Marco Teórico} % First part of the thesis
\include{Chapters/Chapter02} % Chapter 2 HTTP
\include{Chapters/Chapter03} % Chapter 3 P2P
\include{Chapters/Chapter04} % Chapter 4 Modelos de Web Caching
\include{Chapters/Chapter05} % Chapter 5 Modelos de Consistencia
\include{Chapters/Chapter06} % Chapter 6 Comunidades Virtuales
...
\part{Diseño del CWC} % Second part of the thesis
\include{Chapters/Chapter07} % Chapter 7 Especificación de Requerimientos
\include{Chapters/Chapter08} % Chapter 8 Modelo de WebCaching
...
\include{Chapters/Chapter09} % Chapter 9 - Rendimiento
\include{Chapters/Chapter10} % Chapter 10 - Análisis y Resultados

\part{Conclusiones} % Second part of the thesis
\include{Chapters/Chapter11} % Chapter 11 - Conclusiones y Trabajo Futuro
